...
function UpdatePageComp(props) {
  ...
  const getProjectDetail = async (projectID) => {
    ...
    try {
      ...
      if (res.data.success) {
        console.log(res);
        setCurrentImage(res.data.project.imageName);
        setName(res.data.project.projectName);
        setLimit(res.data.project.wlLimit);
        setEtherPrice(res.data.project.etherPrice);
        setClankPrice(res.data.project.clankPrice);
        setDescription(res.data.project.description);
        setEndTime(new Date(res.data.project.endTime));
      }
    } catch (err) {
      // notify("error" + err);
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.put(`api/project/update`, filesTemp);
      console.log("res", res);
      ...
      <div className="createPageComp-layout">
        <Container>
          ...
          <Row>
            ...
            <Col lg="8">
              <div className="createPageComp-title-layout">
                <h2 className="preview-title">Current Image.</h2>
              ...
              <h2 className="createPageComp-title">
